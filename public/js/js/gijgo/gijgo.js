...
gj.datepicker.config = {
    base: {
        months: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Augosto', 'Septimbre', 'Octubre', 'Noviembre', 'Diciembre'],
    ...
    fontawesome: {
        icons: {
            rightIcon: '<span class="input-group-addon" id="Calen"><i class="fa fa-calendar" aria-hidden="true"></i></span>',
...
gj.datepicker.methods = {
    ...
    createCalendar: function ($datepicker) {
        var date, data = $datepicker.data(),
            ...
            $calendar = $('<div role="calendar" id="Cal"/>').addClass(data.style.calendar).attr('guid', $datepicker.attr('data-guid')),
            $table = $('<table/>'),
            $thead = $('<thead/>');
